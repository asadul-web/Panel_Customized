...
<div class="breadcrumb-item active">Reseller List</div>
</div>
</div>
...
<div class="card-body">
<div class="accountalert"></div>
<div class="form-group">
<label for="username">Username</label>
<input class="form-control profile-username" type="text" readonly>
</div>
<div class="form-group">
<label for="upline">Upline</label>
<input class="form-control profile-upline" type="text" readonly>
</div>
{if $user_level_2=='reseller'}
<div class="form-group">
<label for="upline">Credits</label>
<input class="form-control profile-credits" type="text" readonly>
</div>
{/if}
</div>
</div>
...
<div class="card card-primary">
<div class="card-header">
<h2 class="section-title">Reseller List</h2>
</div>
<div class="card-body">
<table class="table table-striped table-listreseller" style="width: 100%">
<thead>
<tr>
<th>Username</th>
<th>Credits</th>
...
{include file='js/page/viewreseller_js.tpl'}
