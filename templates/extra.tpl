...
<div class="card-body">
    ...
    <div class="form-group mt-3">
        <button type="button" class="btn btn-primary btn-lg btn-block btn-createtrial" onclick="create()">Create Trial</button>
    </div>
    <div class="form-group">
        <btn type="button" class="btn btn-primary btn-lg btn-block btn-checkaccount" onclick="check()">Check Account</btn>
    </div>
    <div class="form-group">
        <btn type="button" class="btn btn-primary btn-lg btn-block btn-devicereset" onclick="device()">Reset Device</btn>
    </div>
...
{include file='js/page/extra_js.tpl'}
