...
<div class="breadcrumb-item active">Deleted Log</div>
</div>
</div>
...
<h2 class="section-title">Deleted Users Log</h2>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-striped table-deleted" style="width: 100%">
<thead>
<tr>
<th>Date</th>
<th>User</th>
...
{include file='js/page/logdelete_js.tpl'}
