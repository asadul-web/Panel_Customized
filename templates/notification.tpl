...
<div class="breadcrumb-item active">Notification</div>
</div>
</div>
...
<h2 class="section-title">Create Notification</h2>
</div>
<div class="card-body">
<div class="test"></div>
...
<form action="" class="add-notification" autocomplete="off">
<input type="hidden" name="submitted" name="submitted" value="add_notification">
<input type="hidden" name="_key" id="_key" value="{$firenet_encrypt}">
<div class="form-group">
<label for="title">Title</label>
<input id="title" type="text" class="form-control" name="title" tabindex="1" required="">
</div>
<div class="form-group">
<label for="notificationtype">Type</label>
<select id="notificationtype" class="form-control select2" name="type" data-minimum-results-for-search="-1">
...
<textarea class="summernote-simple" name="post"></textarea>
</div>
<div class="form-group">
<button type="submit" class="btn btn-primary btn-add-notification">Publish</button>
...
<div class="card card-primary">
<div class="card-header">
<h2 class="section-title">Notification List</h2>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-listnotification" style="width: 100%">
<thead>
<tr>
<th>Title</th>
<th>Type</th>
...
{include file='js/page/notification2_js.tpl'}
