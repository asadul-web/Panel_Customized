...
<div class="breadcrumb-item active">Credit Log</div>
</div>
</div>
...
<h2 class="section-title">Credit Log</h2>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-striped table-credits " width="100%">
<thead>
<tr>
<th>Date</th>
<th>Sender</th>
...
{include file='js/page/logcredit_js.tpl'}
