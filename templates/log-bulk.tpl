...
<div class="breadcrumb-item active">Bulk Log</div>
</div>
</div>
...
<h2 class="section-title">Bulk Log</h2>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-striped table-bulk" style="width: 100%">
<thead>
<tr>
<th>Date</th>
<th>Creator</th>
...
{include file='js/page/logbulk_js.tpl'}
