...
<input type="hidden" name="_key" id="_key_single" value="{$firenet_encrypt}">
...
<option value="normal" selected="">Normal (1 Month)</option>
...
<input type="hidden" name="_key" id="_key_bulk" value="{$firenet_encrypt}">
<div class="form-group">
