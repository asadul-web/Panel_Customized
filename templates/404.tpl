...
<div class="row">
<div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4" style="padding-top: 100px">
<div class="card-body">
...
<h2>404 Not Found</h2>
<p class="lead">
We tried it, but failed when requesting data to the server, sorry.
</p>
<a href="/" class="btn btn-warning mt-4">Home</a>
</div>
</div>
</div>
</div>
